            ...
            <ImageBackground source={require('../images/signIn.png')}
                ...
                <View style={{flex: 1, marginTop: 20,}}>
                    ...
                    {this.state.showFirst?
                        ...
                        <View style={{marginTop: 35}}>
                            ...
                            <View style={styles.centerItem}>
                                <Row size={12}>
                                    <Col sm={6} md={6} lg={6} style={styles.centerItem}>
                                        <TextInput
                            ...
                            <Row size={12}>
                                <Col sm={5} md={5} lg={5} style={styles.centerItem}>
                                    <Text style={styles.errorState}>{this.state.erroremailId}</Text>
                                </Col>
                            </Row>
                            <View style={styles.centerItem}>
                                <TouchableOpacity
                        ...
                        <View style={{ marginTop: 30}}>
                            ...
                            <Row size={12}>
                                <Col sm={5} md={5} lg={5} style={{alignItems: 'center',}}>
                                    <Text style={styles.errorState}>{this.state.errorPassword}</Text>
                                </Col>
                            </Row>
                            ...
                            <Row size={12}>
                                <Col sm={6} md={6} lg={6} style={styles.centerItem}>
                                    <Text style={styles.errorState}>{this.state.errorcPassword}</Text>
                                </Col>
                            </Row>
                    ...
                    <View style={styles.bottomView}>
                        <TouchableOpacity
                            onPress={() => {
                                this.props.navigation.navigate('SignUp',{logIn:false})
                            }
                            }>
...
const styles = StyleSheet.create({
    ...
    errorState:{paddingLeft:13,color:'#d70101',
        fontSize:11}
});
